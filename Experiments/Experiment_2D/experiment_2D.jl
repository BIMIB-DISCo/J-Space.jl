...
for mut_rate in mut_driver_rate
    ...
    for i in 1:10
        ...
        if Sys.iswindows()
            mkpath(".\\Experiments\\Experiment_2D\\Fasta\\") # Create folder
            path_for_fasta = ".\\Experiments\\Experiment_2D\\Fasta\\"
        else
            mkpath("./Experiments/Experiment_2D/Fasta/")
            path_for_fasta = "./Experiments/Experiment_2D/Fasta/"
        end
